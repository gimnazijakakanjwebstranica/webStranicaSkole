...
import { MdFormatListNumbered, MdDelete } from "react-icons/md";
...
const AdminPanel = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      await axios.post(`${BACKEND_URL}/admin`, { username, password });
      alert("Uspješno kreiran admin");
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-5 justify-center">
            <div className="max-w-md min-w-[350px] p-6 bg-white rounded-md shadow-md">
              <h2 className="text-xl mb-4 font-semibold">Kreiraj novog admina</h2>
              ...
              {showModal && (
                <div className="font-link fixed top-0 left-0 z-50 w-full h-full flex items-center justify-center bg-gray-800 bg-opacity-50">
                  <div className="bg-white p-4 rounded-md">
                    <p className="mb-4">Da li ste sigurni da želite obrisati admina?</p>
                ...
                <table className="font-link border-separate border-spacing-2">
                  <thead className="rounded">
                    <tr>
                      ...
                      <th className="border rounded-md p-1 border-slate-600">Operacije</th>
                    </tr>
                  </thead>
                  <tbody>
                      ...
                      <tr key={admin._id} className="h-8">
                        ...
                        <td className="border border-slate-700 rounded-md text-center">
                          <div className="flex justify-center gap-4">
                            <button onClick={() => showModalToDelete(admin.id)}>
                              <MdDelete className="cursor-pointer" style={{ color: "red" }} />
                            </button>
                          </div>
                        </td>
                      </tr>
