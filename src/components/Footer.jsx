      ...
      <div className="container mx-auto flex flex-wrap justify-around">
        ...
        <div className="lg:w-1/4 md:w-1/2 p-4">
          <div className="wrapper row4">
            <footer
              id="footer"
              className="flex items-center justify-center bg-gray-800 text-white py-8"
            >
              <div className="lg:w-1/4 md:w-1/2 p-4">
                ...
                <ul className="flex space-x-4">
                  <li>
                    ...
                    <a
                      ...
                      href="https://www.facebook.com/gimn.kakaknj"
                    >
                  ...
                  <li>
                    <FaInstagram />
                    <a className="faicon-instagram" href="#">
                      <i className=""></i>
                    </a>
                  </li>
                  <li>
                    <SiGmail />
                    <a className="faicon-gmail" href="#">
                      <i className=""></i>
                    </a>
                  </li>
                </ul>
              </div>
              <div className="lg:w-1/4 md:w-1/2 p-4"></div>
            </footer>
          </div>
        </div>
        ...
        {/* Kreator stranice */}
        <div className="lg:w-1/4 md:w-1/2 p-4">
          <h6 className="text-xl font-semibold mb-2 right-4">
            Kreator stranice
          </h6>
          <ul className="list-none p-0 m-0">
            <li className="mb-2">
