...
const BurgerMenu = ({ isOpen, onClose }) => {
  ...
  if (!isOpen) return null
    ...
    return (
      ...
      >
        <div className="transform  transition-all duration-300 fixed left-0 h-full bg-white w-[calc(100% / 3)] p-4 pt-3 rounded shadow-lg">
